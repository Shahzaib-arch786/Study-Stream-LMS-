        ...
        <div class="main">
            ...
            <div class="details">
                <div class="recentInvoices">
                    ...
                    <form action="submitStudent.php" method="POST" class="from">
                        <div class="form-groups">
                            <table>
                                <tr>
                                    <td><label for="student_name">Student's Name:</label></td>
                                    <td colspan="3"><input type="text" id="student_name" name="student_name"
                                ...
                                <tr>
                                <td><label for="student_rollno">Student's Roll No:</label></td>
                                    <td colspan="3"><input type="text" id="student_rollno" name="student_rollno"
                                ...
                                <tr>
                                    <td><label for="home_address">Student's Home Address:</label></td>
                                ...
                                <tr>
                                    <td><label for="father_address">Address (if different from student):</label></td>
                                ...
                                <tr>
                                    <td><label for="mother_address">Address (if different from student):</label></td>
                                    <td colspan="5"><input type="text" id="mother_address" name="mother_address"
                                            placeholder="Enter address"></td>
                                </tr>
                                <tr>
                                    <td><label for="lives_with">Student lives with:</label></td>
                                    <td colspan="5" class="radio-container">
                                        <input type="radio" id="lives_with_both" name="lives_with" value="both_parents">
                                        <label for="lives_with_both">Both Parents</label>
                                        <input type="radio" id="lives_with_mother" name="lives_with" value="mother">
                                        <label for="lives_with_mother">Mother</label>
                                        <input type="radio" id="lives_with_father" name="lives_with" value="father">
                                        <label for="lives_with_father">Father</label>
                                        <input type="radio" id="lives_with_other" name="lives_with" value="other">
                                        <label for="lives_with_other">Other:</label>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td><label for="pediatrician">Pediatrician:</label></td>
                                    <td colspan="2"><input type="text" id="pediatrician" name="pediatrician"
                                            placeholder="Enter pediatrician name"></td>
                                    <td><label for="preferred_hospital">Preferred Hospital:</label></td>
                                    <td colspan="2"><input type="text" id="preferred_hospital" name="preferred_hospital"
                                            placeholder="Enter hospital name"></td>
                                </tr>
                                <tr>
